 ...
 */
package org.gol.ide.contentassist.antlr;
...
import org.gol.ide.contentassist.antlr.internal.InternalGolParser;
...
public class GolParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, GolGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getGridSizeAccess().getHeightAssignment_4(), "rule__GridSize__HeightAssignment_4");
			builder.put(grammarAccess.getGridSizeAccess().getWidthAssignment_7(), "rule__GridSize__WidthAssignment_7");
