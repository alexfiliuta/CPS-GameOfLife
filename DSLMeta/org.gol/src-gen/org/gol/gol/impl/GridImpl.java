 ...
 * </p>
 * <ul>
 *   <li>{@link org.gol.gol.impl.GridImpl#getSize <em>Size</em>}</li>
 *   <li>{@link org.gol.gol.impl.GridImpl#getPopulatedCells <em>Populated Cells</em>}</li>
 *   <li>{@link org.gol.gol.impl.GridImpl#getPredefinedPatterns <em>Predefined Patterns</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GridImpl extends MinimalEObjectImpl.Container implements Grid
{
  ...
  public NotificationChain basicSetSize(GridSize newSize, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GolPackage.GRID__SIZE, oldSize, newSize);
  ...
  public void setSize(GridSize newSize)
  {
    if (newSize != size)
    {
      ...
      if (size != null)
        msgs = ((InternalEObject)size).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - GolPackage.GRID__SIZE, null, msgs);
      if (newSize != null)
        msgs = ((InternalEObject)newSize).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - GolPackage.GRID__SIZE, null, msgs);
      msgs = basicSetSize(newSize, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GolPackage.GRID__SIZE, newSize, newSize));
  }
  ...
  public EList<PopulatedCell> getPopulatedCells()
  {
    ...
    {
      populatedCells = new EObjectContainmentEList<PopulatedCell>(PopulatedCell.class, this, GolPackage.GRID__POPULATED_CELLS);
    }
  ...
  public EList<String> getPredefinedPatterns()
  {
    ...
    {
      predefinedPatterns = new EDataTypeEList<String>(String.class, this, GolPackage.GRID__PREDEFINED_PATTERNS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case GolPackage.GRID__SIZE:
        return basicSetSize(null, msgs);
      case GolPackage.GRID__POPULATED_CELLS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case GolPackage.GRID__PREDEFINED_PATTERNS:
