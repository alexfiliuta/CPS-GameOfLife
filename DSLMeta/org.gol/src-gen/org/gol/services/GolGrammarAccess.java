...
public class GolGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class GameElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gol.Gol.Game");
	...
	public class GridElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gol.Gol.Grid");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final Keyword cPredefinedPatternsKeyword_5_0 = (Keyword)cGroup_5.eContents().get(0);
		private final Assignment cPredefinedPatternsAssignment_5_1 = (Assignment)cGroup_5.eContents().get(1);
		private final RuleCall cPredefinedPatternsPredefinedPatternParserRuleCall_5_1_0 = (RuleCall)cPredefinedPatternsAssignment_5_1.eContents().get(0);
		...
		//'PredefinedPatterns:'
		public Keyword getPredefinedPatternsKeyword_5_0() { return cPredefinedPatternsKeyword_5_0; }
		
		//predefinedPatterns+=PredefinedPattern+
		public Assignment getPredefinedPatternsAssignment_5_1() { return cPredefinedPatternsAssignment_5_1; }
		
		//PredefinedPattern
		public RuleCall getPredefinedPatternsPredefinedPatternParserRuleCall_5_1_0() { return cPredefinedPatternsPredefinedPatternParserRuleCall_5_1_0; }
	}
	public class GridSizeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gol.Gol.GridSize");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final Keyword cHeightKeyword_3 = (Keyword)cGroup.eContents().get(3);
		...
		//'height:'
		public Keyword getHeightKeyword_3() { return cHeightKeyword_3; }
	...
	public class PredefinedPatternElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gol.Gol.PredefinedPattern");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Keyword cGliderKeyword_0 = (Keyword)cAlternatives.eContents().get(0);
		private final Keyword cBlinkerKeyword_1 = (Keyword)cAlternatives.eContents().get(1);
		...
		//'Glider'
		public Keyword getGliderKeyword_0() { return cGliderKeyword_0; }
		
		//'Blinker'
		public Keyword getBlinkerKeyword_1() { return cBlinkerKeyword_1; }
	}
	public class PopulatedCellElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gol.Gol.PopulatedCell");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class RulesElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gol.Gol.Rules");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ConditionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gol.Gol.Condition");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class RuleElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gol.Gol.Rule");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SeparatorElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gol.Gol.Separator");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class StateElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gol.Gol.State");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class BoolOpElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gol.Gol.BoolOp");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class OutcomeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.gol.Gol.Outcome");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	private final PredefinedPatternElements pPredefinedPattern;
	...
	public GolGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pPredefinedPattern = new PredefinedPatternElements();
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.gol.Gol".equals(grammar.getName())) {
				return grammar;
			}
	...
	//PredefinedPattern:
	//    'Glider' | 'Blinker';
	public PredefinedPatternElements getPredefinedPatternAccess() {
		return pPredefinedPattern;
	}
	
	public ParserRule getPredefinedPatternRule() {
		return getPredefinedPatternAccess().getRule();
	}
